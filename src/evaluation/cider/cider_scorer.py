...
def cook_refs(refs, n=4):  # lhuang: oracle will call with "average"
    ...
    :param n: int : number of ngrams for which (ngram)
...
class CiderScorer(object):
    ...
    def compute_cider(self):
        def counts2vec(cnts):
            ...
            The function returns vec, an array of dictionary
            that store mapping of n-gram and tf-idf weights.
        ...
        def sim(vec_hyp, vec_ref, norm_hyp, norm_ref, length_hyp, length_ref):
            ...
            :param vec_hyp: array of dictionary
                for vector corresponding to hypothesis
            :param vec_ref: array of dictionary
                for vector corresponding to reference
            :param norm_hyp: array of float
                for vector corresponding to hypothesis
            :param norm_ref: array of float
                for vector corresponding to reference
